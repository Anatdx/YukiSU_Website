...
const hero = {
  badge: '终极 Android Root 方案，nb我fork的都脸红',
  title: 'YukiSU',
  subtitle: '强大的内核级 Root 权限，安全性让步',
  description: '体验新一代的 Android Root 管理',
  logo: '/logo.svg',
  primary: { label: '开始使用', href: '/zh/guide/installation' },
  secondary: { label: '访问 GitHub', href: 'https://github.com/Anatdx/YukiSU' },
  metrics: [
    { label: '活跃用户', value: '1+' },
    { label: '支持设备', value: '1+' },
    { label: 'GitHub Star', value: '0+' },
    { label: '社区成员', value: '1+' }
  ]
}
...
const features = {
  title: '为什么选择 YukiSU',
  description: '安全、性能与可靠性在哪？，全都围绕内核级 Root 打造',
  items: [
    {
      title: '非 GKI 内核支持',
    ...
    },
    {
      ...
      body: '这东西已经被metamodule取代了',
      icon: 'solar:zip-file-outline',
      accent: 'blue'
    },
    {
      title: '支持 KPM 内核模块',
      body: '移植自 Apatch 的 KPM 模块支持但是没几个模块',
...
const steps = {
  ...
  secondary: { label: '下载最新版本', href: 'https://github.com/Anatdx/YukiSU/releases' }
}
  ...
  links: [
    {
      ...
      items: [
        ...
        { label: 'GitHub 仓库', href: 'https://github.com/Anatdx/YukiSU' },
        { label: '下载', href: 'https://github.com/Anatdx/YukiSU/releases' },
        { label: '问题反馈', href: 'https://github.com/Anatdx/YukiSU/issues' }
      ]
    },
    {
      title: '社区',
